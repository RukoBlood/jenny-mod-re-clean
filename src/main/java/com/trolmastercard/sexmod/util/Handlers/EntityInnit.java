...
public class EntityInnit {
    public static void Register() {
        EntityInnit.RegisterNPCEntity("jenny", JennyEntity.class, PlayerGirlEntity.JENNY.npcID, 3286592, 12655237);
        EntityInnit.RegisterNPCEntity("ellie", EllieEntity.class, PlayerGirlEntity.ELLIE.npcID, 0x161616, 0x980000);
        EntityInnit.RegisterNPCEntity("slime", SlimeEntity.class, PlayerGirlEntity.SLIME.npcID, 13167780, 8244330);
        EntityInnit.RegisterNPCEntity("bia", BiaEntity.class, PlayerGirlEntity.BIA.npcID, 7488816, 7254603);
        EntityInnit.RegisterNPCEntity("bee", BeeEntity.class, PlayerGirlEntity.BEE.npcID, 16701032, 4400155);
        EntityInnit.RegisterNPCEntity("luna", LunaEntity.class, PlayerGirlEntity.LUNA.npcID, 7881787, 7940422);
        EntityInnit.RegisterOtherEntity("allie", AllieEntity.class, PlayerGirlEntity.ALLIE.npcID);
        EntityInnit.RegisterOtherEntity("kobold", KoboldEntity.class, PlayerGirlEntity.KOBOLD.npcID);
        EntityInnit.RegisterOtherEntity("kobold_egg", KoboldEggEntity.class, 4674237);
        EntityInnit.RegisterNPCEntity("goblin", GoblinEntity.class, PlayerGirlEntity.GOBLIN.npcID, 39424, 19456);
        EntityInnit.RegisterNPCEntity("galath", GalathEntity.class, PlayerGirlEntity.GALATH.npcID, 0xFF0000, 0xFF0000);
        EntityInnit.RegisterNPCEntity("manglelie", ManglelieEntity.class, PlayerGirlEntity.MANGLELIE.npcID, 0xF9F9F9, 8485574);
        EntityInnit.RegisterOtherEntity("custom_model", CustomModelEntity.class, 6281823);
        EntityInnit.RegisterPlayerEntity("player_jenny", PlayerJenny.class, PlayerGirlEntity.JENNY.playerID);
        EntityInnit.RegisterPlayerEntity("player_ellie", PlayerEllie.class, PlayerGirlEntity.ELLIE.playerID);
        EntityInnit.RegisterPlayerEntity("player_slime", PlayerSlime.class, PlayerGirlEntity.SLIME.playerID);
        EntityInnit.RegisterPlayerEntity("player_bia", PlayerBia.class, PlayerGirlEntity.BIA.playerID);
        EntityInnit.RegisterPlayerEntity("player_bee", PlayerBee.class, PlayerGirlEntity.BEE.playerID);
        EntityInnit.RegisterPlayerEntity("player_allie", PlayerAllie.class, PlayerGirlEntity.ALLIE.playerID);
        EntityInnit.RegisterPlayerEntity("player_kobold", PlayerKobold.class, PlayerGirlEntity.KOBOLD.playerID);
        EntityInnit.RegisterPlayerEntity("player_goblin", PlayerGoblin.class, PlayerGirlEntity.GOBLIN.playerID);
        EntityInnit.RegisterPlayerEntity("player_luna", PlayerLuna.class, PlayerGirlEntity.LUNA.playerID);
        EntityInnit.RegisterPlayerEntity("player_galath", PlayerGalath.class, PlayerGirlEntity.GALATH.playerID);
        EntityInnit.RegisterOtherEntity("friendly_slime", FriendlySlimeEntity.class, 5548484);
        EntityInnit.RegisterOtherEntity("luna_hook", LunaHookEntity.class, 4768742);
        EntityInnit.RegisterOtherEntity("energy_ball", EnergyBallEntity.class, 2565153);
        EntityInnit.RegisterOtherEntity("pyrocinical", PyrocynicalEntity.class, 515153);
