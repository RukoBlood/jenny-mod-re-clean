...
public class EventHandler {
    public static void Register(boolean showDebug) throws IOException {
        ...
        MinecraftForge.EVENT_BUS.register(LampItem.LAMP_ITEM);
        MinecraftForge.EVENT_BUS.register(DragonStaffItem.DRAGON_STAFF);
        MinecraftForge.EVENT_BUS.register(EditorWand.EDITOR_WAND);
        MinecraftForge.EVENT_BUS.register(new LunaRod());
        MinecraftForge.EVENT_BUS.register(new PlayerGirlEvents());
        MinecraftForge.EVENT_BUS.register(new LunaEntity.EventHandler());
        ...
        MinecraftForge.EVENT_BUS.register(GalathCoin.GALATH_COIN);
        MinecraftForge.EVENT_BUS.register(NYIWinchesterItem.NYI_WINCHESTER_ITEM);
        MinecraftForge.EVENT_BUS.register(new StructureTracker());
        MinecraftForge.EVENT_BUS.register(new AllieWorldData());
        MinecraftForge.EVENT_BUS.register(new GirlWorldData());
        MinecraftForge.EVENT_BUS.register(ConfigWorldGenHandler.Generate());
        MinecraftForge.EVENT_BUS.register(new ManglelieEntity.EventHandler());
    ...
    static void RegisterIfAllowed() {
        ...
        MinecraftForge.EVENT_BUS.register(new GirlRenderEvent());
        ...
        MinecraftForge.EVENT_BUS.register(new ClothingGui.EventHandler());
        MinecraftForge.EVENT_BUS.register(new CustomModel.ChatHandler());
        MinecraftForge.EVENT_BUS.register(new EscapeMinigameUI());
        MinecraftForge.EVENT_BUS.register(new CummyEntity());
        MinecraftForge.EVENT_BUS.register(new GalathFlightUI());
    }
