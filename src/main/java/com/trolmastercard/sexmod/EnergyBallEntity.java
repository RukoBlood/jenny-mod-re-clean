...
extends EntityLiving {
    ...
    void b() {
        ...
        NetworkRegistry.networkWrapper.sendToAllTracking((IMessage)new bv_class101(vec3d, true), (Entity)this);
    ...
    public boolean attackEntityFrom(DamageSource damageSource, float f) {
        ...
        if (!this.world.isRemote && "arrow".equals(damageSource.damageType)) {
            this.setHealth(0.0f);
            this.i = false;
            NetworkRegistry.networkWrapper.sendToAllTracking((IMessage)new bv_class101(this.getPositionVector(), false), (Entity)this);
