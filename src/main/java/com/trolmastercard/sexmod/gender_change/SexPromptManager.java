...
public class SexPromptManager {
    ...
    public void setNewActivePrompt(@Nonnull SexPrompt activePrompt) {
        ...
        TextComponentString mainPromptMessage = new TextComponentString(TextFormatting.LIGHT_PURPLE + (activePrompt.senderIsMale ? boy.getName() : girl.getName()) + " " + TextFormatting.DARK_PURPLE + I18n.format("genderswap.sexpromt.playerxaskedfory", new Object[0]) + " " + TextFormatting.LIGHT_PURPLE + I18n.format(activePrompt.action, new Object[0]));
        TextComponentString timeoutWarningMessage = new TextComponentString(TextFormatting.DARK_PURPLE + I18n.format("genderswap.sexpromt.autodeletion", new Object[0]));
        TextComponentString actionButtonsMessage = new TextComponentString(TextFormatting.DARK_PURPLE + "[ " + TextFormatting.LIGHT_PURPLE + I18n.format("genderswap.sexpromt.accept", new Object[0]) + TextFormatting.DARK_PURPLE + " | " + TextFormatting.LIGHT_PURPLE + I18n.format("genderswap.sexpromt.decline", new Object[0]) + TextFormatting.DARK_PURPLE + " ]");
    ...
    public void answer(ClientChatEvent event) {
        ...
        if (inputMsg.equals(I18n.format("genderswap.sexpromt.accept").toLowerCase())) {
        ...
        if (inputMsg.equals(I18n.format("genderswap.sexpromt.decline").toLowerCase())) {
            Minecraft.getMinecraft().player.sendMessage(new TextComponentString(TextFormatting.DARK_PURPLE + I18n.format("genderswap.sexpromt.declineconformation", new Object[0])));
            this.deletePrompt();
            event.setCanceled(true);
        }
    }
    ...
    void startSex(String animationID, UUID receiver, UUID sender) {
        PacketHandler.INSTANCE.sendToServer(new StartStandingSexAnimation(receiver, sender, animationID));
    }
