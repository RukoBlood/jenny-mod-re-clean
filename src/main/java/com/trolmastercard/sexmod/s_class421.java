    ...
    implements IMessageHandler<s_class421, IMessage> {
        public static void a(GirlEntity em_class2582) {
            ...
            if (em_class2582 instanceof PlayerGirl && em_class2582.world.getPlayerEntityByUUID(((PlayerGirl)em_class2582).java_util_UUID_m()) != null) {
                NetworkRegistry.networkWrapper.sendTo((IMessage)new gz_class393(true), (EntityPlayerMP)FMLCommonHandler.instance().getMinecraftServerInstance().getWorld(em_class2582.dimension).getPlayerEntityByUUID(((PlayerGirl)em_class2582).java_util_UUID_m()));
