...
public class WorldGenCustomStructure extends WorldGenerator implements IStructure {
    ...
    public WorldGenCustomStructure(String name) {
    ...
    public void generateStructureRotated(World world, BlockPos blockPos, Rotation rotation) {
        ResourceLocation resourceLocation;
        MinecraftServer minecraftServer = world.getMinecraftServer();
        TemplateManager templateManager = worldServer.getStructureTemplateManager();
        Template template = templateManager.get(minecraftServer, resourceLocation = new ResourceLocation("sexmod", this.structureName));
    ...
    public boolean generate(World world, Random random, BlockPos blockPos) {
        this.generateStructure(world, blockPos);
        return true;
    }
}
