...
public class af_class27 {
    ...
    public static Vec3d[][] a(GirlEntity em_class2582, float f, String string, String string2, Vector3f f7_class2922, Vector3f f7_class2923) {
        Vec3d[] vec3dArray = af_class27.b(em_class2582, f, string, string2, f7_class2922, f7_class2923);
        return af_class27.b(vec3dArray);
    }

    static Vec3d[] b(GirlEntity em_class2582, float f, String string, String string2, Vector3f f7_class2922, Vector3f f7_class2923) {
        int n;
        Vec3d vec3d = em_class2582.b(string);
        Vec3d vec3d2 = em_class2582.b(string2);
        Vec3d[] vec3dArray = new Vec3d[8];
        if (f7_class2922.x == 0.0f && f7_class2923.x == 0.0f) {
            vec3dArray[0] = new Vec3d(0.0, f7_class2922.y, f7_class2922.z);
            vec3dArray[1] = new Vec3d(0.0, -f7_class2922.y, f7_class2922.z);
            vec3dArray[2] = new Vec3d(0.0, -f7_class2922.y, -f7_class2922.z);
            vec3dArray[3] = new Vec3d(0.0, f7_class2922.y, -f7_class2922.z);
            vec3dArray[4] = new Vec3d(0.0, f7_class2923.y, f7_class2923.z);
            vec3dArray[5] = new Vec3d(0.0, -f7_class2923.y, f7_class2923.z);
            vec3dArray[6] = new Vec3d(0.0, -f7_class2923.y, -f7_class2923.z);
            vec3dArray[7] = new Vec3d(0.0, f7_class2923.y, -f7_class2923.z);
        } else {
            vec3dArray[0] = new Vec3d(f7_class2922.x, f7_class2922.y, 0.0);
            vec3dArray[1] = new Vec3d(-f7_class2922.x, f7_class2922.y, 0.0);
            vec3dArray[2] = new Vec3d(-f7_class2922.x, -f7_class2922.y, 0.0);
            vec3dArray[3] = new Vec3d(f7_class2922.x, -f7_class2922.y, 0.0);
            vec3dArray[4] = new Vec3d(f7_class2923.x, f7_class2923.y, 0.0);
            vec3dArray[5] = new Vec3d(-f7_class2923.x, f7_class2923.y, 0.0);
            vec3dArray[6] = new Vec3d(-f7_class2923.x, -f7_class2923.y, 0.0);
    ...
    public static void a(BufferBuilder bufferBuilder, Vec3d[][] vec3dArray, ColorRGBA gv_class3882) {
        Vec3d[][] vec3dArray2 = vec3dArray;
        int n = vec3dArray2.length;
        for (int i = 0; i < n; ++i) {
            Vec3d[] vec3dArray3;
            for (Vec3d vec3d : vec3dArray3 = vec3dArray2[i]) {
                bufferBuilder.pos(vec3d.x, vec3d.y, vec3d.z).tex(0.0, 0.0).color(gv_class3882.r, gv_class3882.g, gv_class3882.b, gv_class3882.a).endVertex();
            }
        }
    }
