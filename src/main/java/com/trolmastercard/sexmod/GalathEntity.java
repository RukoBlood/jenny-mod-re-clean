...
b7_class68 {
    ...
    void void_C() {
        if (this.entityDataManager.get(L).booleanValue()) {
            this.bb = true;
            return;
        }
        switch (this.currentAction()) {
    ...
    void void_a(Entity entity) {
        ...
        NetworkRegistry.networkWrapper.sendToAllTracking((IMessage)new bv_class101(this.getPositionVector(), true), (Entity)this);
        this.f((Vec3d)null);
    ...
    void void_O() {
        ...
        for (EntityWitherSkeleton entityWitherSkeleton : this.bI) {
            ...
            NetworkRegistry.networkWrapper.sendToAllTracking((IMessage)new bv_class101(entityWitherSkeleton.getPositionVector(), true), (Entity)this);
    ...
    void void_T() {
        ...
        if (this.world.getBlockState(blockPos).getBlock() instanceof BlockLiquid) {
            ...
            NetworkRegistry.networkWrapper.sendToAllTracking((IMessage)new bv_class101(new Vec3d(blockPos2), true), (Entity)this);
    ...
    public void a(String string, UUID uUID) {
        if ("ride".equals(string)) {
            hf_class401.f();
            NetworkRegistry.networkWrapper.sendToServer((IMessage)new bk_class85());
            return;
        }
    ...
    public boolean attackEntityFromPart(MultiPartEntityPart multiPartEntityPart, DamageSource damageSource, float f) {
        ...
        if (multiPartEntityPart == this.V) {
            ...
            NetworkRegistry.networkWrapper.sendToAllTracking((IMessage)new bv_class101(this.V.getPositionVector(), false), (Entity)this);
        }
        if (multiPartEntityPart == this.b2) {
            this.entityDataManager.set(bN, false);
            NetworkRegistry.networkWrapper.sendToAllTracking((IMessage)new bv_class101(this.b2.getPositionVector(), false), (Entity)this);
        }
        return true;
    }
        ...
        this.C.registerSoundListener(soundKeyframeEvent -> {
            switch (soundKeyframeEvent.sound) {
                ...
                case "rapeHurt": {
                    ...
                    NetworkRegistry.networkWrapper.sendToServer((IMessage)new g__class356(false));
                    break;
                }
                case "enableRapeUI": {
                    if (!this.boolean_n()) break;
    ...
    public static class a_inner298 {
        ...
        public void a(LivingDeathEvent livingDeathEvent) {
            ...
            if (!f__class2972.maybeMountedByMangFn()) {
                ...
                NetworkRegistry.networkWrapper.sendToAllTracking((IMessage)new ab_class21(f__class2972.girlID(), GalathMangTracker.b(f__class2972)), (Entity)f__class2972);
        ...
        public void a(PlayerWakeUpEvent playerWakeUpEvent) {
            ...
            be_class78.a(500, () -> {
                entityPlayer.setPositionAndUpdate(vec3d.x, vec3d.y, vec3d.z);
                NetworkRegistry.networkWrapper.sendTo((IMessage)new aq_class39(-10.0f, f + 180.0f + 5.0f, 0), (EntityPlayerMP)entityPlayer);
            });
        }
    }
}
