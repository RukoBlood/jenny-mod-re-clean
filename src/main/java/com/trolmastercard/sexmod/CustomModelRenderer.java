...
extends GeoEntityRenderer<CustomModelEntity> {
    ...
    boolean d(CustomModelEntity cy_class1532) {
        ...
        NetworkRegistry.networkWrapper.sendToServer((IMessage)new fw_class332(string2, cy_class1532.b()));
        return true;
    }
    ...
    void a(CustomModels.b_inner96 b_inner962, CustomModelEntity cy_class1532, float f) {
