        ...
        AnimationController.ISoundListener iSoundListener = soundKeyframeEvent -> {
            switch (soundKeyframeEvent.sound) {
                case "summonMSG1": {
                    ...
                    this.a(SoundEventHandler.GIRLS_ALLIE_SCAWY[0], 0.5f);
                    break;
                }
                case "summonMSG2": {
                    this.void_a(I18n.format("allie.dialogue.summon2", new Object[0]));
                    this.PlaySound(SoundEventHandler.GIRLS_ALLIE_GIGGLE[this.getRNG().nextInt(4)]);
                    break;
                }
                case "summonMSG3": {
                ...
                case "summonMSG4": {
                    ...
                    this.PlaySound(SoundEventHandler.GIRLS_ALLIE_LIGHTBREATHING[2]);
                    break;
                }
                case "summonMSG5": {
                    this.void_a(I18n.format("allie.dialogue.summon5", new Object[0]));
                    this.PlaySound(SoundEventHandler.GIRLS_ALLIE_HMPH[4]);
                    break;
                }
                case "summonMSG6": {
                    this.void_a(I18n.format("allie.dialogue.summon6", new Object[0]));
                    this.PlaySound(SoundEventHandler.GIRLS_ALLIE_GIGGLE[3]);
                    break;
                }
                case "summonMSG7": {
                ...
                case "summonMSG8": {
                    ...
                    this.PlaySound(SoundEventHandler.GIRLS_ALLIE_HUH, new int[0]);
                ...
                case "deepthroat_prepareMSG1": {
                    ...
                    this.PlaySound(SoundEventHandler.GIRLS_ALLIE_GIGGLE, new int[0]);
                    break;
                }
                case "deepthroat_prepareMSG2": {
                    this.void_a(I18n.format("allie.dialogue.boys", new Object[0]));
                    this.PlaySound(SoundEventHandler.GIRLS_ALLIE_SIGH[0]);
                    break;
                }
                case "scream": {
                    this.PlaySound(SoundEventHandler.MISC_SCREAM, new int[0]);
                    break;
                }
                case "blackscreen": {
                    if (!this.boolean_n()) break;
                ...
                case "deepthroat_normal_prepareMSG1": {
                    ...
                    this.PlaySound(SoundEventHandler.a(SoundEventHandler.GIRLS_ALLIE_GIGGLE));
                    break;
                }
                case "rich_MSG1": {
                ...
                case "summon_sandMSG1": {
                    ...
                    this.PlaySound(SoundEventHandler.GIRLS_ALLIE_SCAWY[2]);
                    break;
                }
                ...
                case "moan": {
                    this.PlaySound(SoundEventHandler.GIRLS_ALLIE_MOAN, new int[0]);
                    break;
                }
                case "mmm": {
                ...
                case "aftermoan": {
                    this.PlaySound(SoundEventHandler.GIRLS_ALLIE_AFTERSESSIONMOAN, new int[0]);
                }
            }
        };
