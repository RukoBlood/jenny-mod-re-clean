...
implements IMessage {
    ...
    implements IMessageHandler<cu_class146, IMessage> {
        ...
        @SideOnly(value=Side.CLIENT)
        void a() {
            Minecraft.getMinecraft().addScheduledTask(() -> CustomModels.b(true));
        }
        ...
        public IMessage a(cu_class146 cu_class1462, MessageContext messageContext) {
            ...
            if (messageContext.side.isClient()) {
                ...
                String string2 = CustomModels.h() + "/" + string;
            ...
            minecraftServer.addScheduledTask(() -> {
                ...
                for (cu_class146 cu_class1463 : arrayList) {
                    cu_class1463.a(n);
                    minecraftServer.addScheduledTask(() -> NetworkRegistry.networkWrapper.sendTo((IMessage)cu_class1463, messageContext.getServerHandler().player));
                }
            });
            return null;
        }
