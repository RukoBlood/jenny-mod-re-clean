...
public class WorldGeneration extends WorldSavedData implements IWorldGenerator {
    ...
    static private WorldGeneration worldGeneration = null;
    static boolean c = true;

    public static WorldGeneration Generate() {
    ...
    public WorldGeneration(String string) {
        this();
    }

    private WorldGeneration() {
        super(j);
        worldGeneration = this;
    ...
    public void a(WorldEvent.Load load) {
        ...
        world.getMapStorage().getOrLoadData(WorldGeneration.class, j);
    }
    ...
    public void readFromNBT(NBTTagCompound nBTTagCompound) {
        ...
        while (true) {
            ...
            this.d.add(new a_inner345(WorldGeneration.a(string2), string));
            ++n;
        }
    }
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nBTTagCompound) {
        ...
        for (a_inner345 a_inner3452 : this.d) {
            ...
            nBTTagCompound2.setString("sexmod:pos" + n++, WorldGeneration.a(a_inner3452.b));
        }
