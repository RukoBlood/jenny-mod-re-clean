    ...
    public void registerControllers(AnimationData animationData) {
        ...
        ISoundListener iSoundListener = soundKeyframeEvent -> {
            switch (soundKeyframeEvent.sound) {
                ...
                case "rod_shoot": {
                    if (!this.boolean_e()) break;
                    NetworkRegistry.networkWrapper.sendToServer((IMessage)new ej_class253(this.girlID()));
                    break;
                }
                case "eat": {
                ...
                case "eatingDone": {
                    if (this.boolean_e()) {
                        NetworkRegistry.networkWrapper.sendToServer((IMessage)new gk_class373(this.girlID()));
                        this.setCurrentAction(Action.NULL);
                    }
                    this.aa = 1.0f;
                    this.Z = 0.0f;
                ...
                case "throw_away": {
                    if (this.boolean_e()) {
                        NetworkRegistry.networkWrapper.sendToServer((IMessage)new dq_class197(this.girlID()));
                    }
                    this.aa = 1.0f;
                    this.Z = 0.0f;
                    break;
