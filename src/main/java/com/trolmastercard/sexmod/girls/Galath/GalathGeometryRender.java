...
public class GalathGeometryRender {
    ...
    public static void setupRenderTranslations(Minecraft mc, GirlEntity girl, float partialTicks) {
        ...
        Vec3d girlPos = girl.isAnchored() ? girl.getTargetPosition() : RotationHelper.LerpVec3d(new Vec3d(renderBase.lastTickPosX, renderBase.lastTickPosY, renderBase.lastTickPosZ), renderBase.getPositionVector(), (double)partialTicks);
        Vec3d playerPos = RotationHelper.LerpVec3d(new Vec3d(player.lastTickPosX, player.lastTickPosY, player.lastTickPosZ), player.getPositionVector(), (double)partialTicks);
