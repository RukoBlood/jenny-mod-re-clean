...
public class JennyEntity extends Fighter implements bh_class82, IBeddableSexGirl {
    ...
    public void SetHome() {
        ...
        this.PlaySound(SoundEventHandler.GIRLS_JENNY_HAPPYOH[1]);
    }
    ...
    protected SoundEvent getDeathSound() {
        return SoundEventHandler.a(SoundEventHandler.GIRLS_JENNY_SIGH);
    }
    ...
    public void goToSexBed() {
        ...
        if (blockPos == null) {
            this.PlaySound(SoundEventHandler.GIRLS_JENNY_HMPH[2]);
