...
implements bh_class82 {
    ...
    public void SetHome() {
        ...
        this.a(SoundEventHandler.GIRLS_ELLIE_HUH[0], 6.0f);
    }
    ...
    public void goHome() {
        ...
        this.a(SoundEventHandler.GIRLS_ELLIE_SIGH[1], 6.0f);
    }
    ...
    void void_q() {
        ...
        if (this.am == null) {
            ...
            this.world.playSound(null, this.getPosition(), SoundEventHandler.GIRLS_ELLIE_SIGH[0], SoundCategory.NEUTRAL, 6.0f, 1.0f);
            this.s();
            this.void_f();
            return;
        }
    ...
    public void registerControllers(AnimationData animationData) {
        ...
        AnimationController.ISoundListener iSoundListener = soundKeyframeEvent -> {
            switch (soundKeyframeEvent.sound) {
                ...
                case "hugMSG2": {
                    this.h("Hmm...");
                    this.a(SoundEventHandler.GIRLS_ELLIE_HMPH[3], 6.0f);
                    break;
                }
                case "hugMSG3": {
                    this.h("Hey!");
                    this.a(SoundEventHandler.GIRLS_ELLIE_HUH[1], 1.0f);
                    break;
                }
                case "hugMSG4": {
                    this.h(I18n.format("ellie.dialogue.mommyhorny", new Object[0]));
                    this.a(SoundEventHandler.GIRLS_ELLIE_MOMMYHORNY, 0.5f);
                    break;
                }
                case "hugMSG5": {
                    this.h(I18n.format("ellie.dialogue.whattodo", new Object[0]));
                    this.a(SoundEventHandler.GIRLS_ELLIE_HUH[1], 6.0f);
                    break;
                }
                case "hugDone": {
                ...
                case "sitdownMSG1": {
                    this.a(SoundEventHandler.GIRLS_ELLIE_COMETOMOMMY, 0.5f);
                    if (!this.boolean_e()) break;
                    this.h(I18n.format("ellie.dialogue.cometomommy", new Object[0]));
                    break;
                }
                case "cowgirlStartMSG0": {
                    this.a(SoundEventHandler.GIRLS_ELLIE_GIGGLE[4], 6.0f);
                    break;
                }
                ...
                case "cowgirlStartMSG2": {
                    this.a(SoundEventHandler.a(SoundEventHandler.GIRLS_ELLIE_AHH), 6.0f);
                ...
                case "missionary_cumMSG2": {
                    this.a(SoundEventHandler.GIRLS_ELLIE_GOODBOY, 0.5f);
                    if (!this.boolean_n()) break;
                ...
                case "missionary_slowMSG1": {
                    ...
                    if (this.getRNG().nextBoolean() && this.getRNG().nextBoolean()) {
                        this.a(SoundEventHandler.a(SoundEventHandler.GIRLS_ELLIE_MOAN), 6.0f);
                    } else {
                        this.a(SoundEventHandler.a(SoundEventHandler.GIRLS_ELLIE_AHH), 6.0f);
                    }
                    if (!this.boolean_n()) break;
                ...
                case "lipsound": {
                    this.PlaySound(SoundEventHandler.GIRLS_ALLIE_LIPSOUND, new int[0]);
                    if (!this.boolean_n()) break;
                    ds_class200.a(0.02);
                    break;
                }
