...
public class FighterUI extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int xText = (int) Reference.LerpFloat(115.0f, 161.0f, this.secondTransition);
        int xItem = (int) Reference.LerpFloat(91.0f, 137.0f, this.secondTransition);
        int x = (int) Reference.LerpFloat(-30.0f, 120.0f, this.firstTransition);
        int y = 70;
        int yText = 52;
        int yItem = 68;
    ...
    void drawEquipment(int mouseX, int mouseY) {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            this.drawTexturedModalRect(this.extraButtonWidth[i] + buttonX - 18 + (int) Reference.LerpFloat(0.0f, 23.0f, this.secondTransition), buttonY + 2, this.textureXOffset[i], 0, 16, 16);
            this.buttonList.add(new GuiButton(i, buttonX + 1, buttonY, (int)(Reference.LerpFloat(0.0f, 23.0f, this.secondTransition) + (float)this.extraButtonWidth[i]), 20, this.extraButtonWidth[i] <= 14 ? "" : stringBuilder.toString()));
            buttonY += 30;
        }
        this.mc.renderEngine.bindTexture(girlInventoryGUITexture);
