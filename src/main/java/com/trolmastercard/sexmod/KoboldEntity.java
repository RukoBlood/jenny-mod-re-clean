...
dr_class199 {
    ...
    KoboldEntity(World world, UUID uUID, float f) {
        ...
        this.entityDataManager.set(aE, Float.valueOf(f));
    }
    ...
    protected boolean processInteract(EntityPlayer entityPlayer, EnumHand enumHand) {
        ...
        if (itemStack.getItem().equals(Items.NAME_TAG) && entityPlayer.getPersistentID().toString().equals(this.entityDataManager.get(v))) {
    ...
    public void updateAITasks() {
        ...
        if (!this.entityDataManager.get(aC).booleanValue()) {
            if (this.getHealth() != this.getMaxHealth() && ++this.a5 >= 100) {
                ...
                this.a5 = 0;
                NetworkRegistry.networkWrapper.sendToAllTracking((IMessage)new en_class260(this.girlID(), EnumParticleTypes.HEART.getParticleName()), (Entity)this);
            }
        } else {
            this.a5 = 0;
        }
        ...
        this.entityDataManager.set(aZ, KoboldManager.e((UUID)optional.get(), this));
    ...
    void void_w() {
        ...
        if (!"".equals(this.entityDataManager.get(h))) {
            return;
        }
        if (this.entityDataManager.get(ak).booleanValue()) {
            return;
        }
        String string = (String)this.entityDataManager.get(v);
    ...
    protected void U() {
        ...
        boolean bl3 = false;
        if (this.boolean_J()) {
            bl3 = ((String)this.entityDataManager.get(v)).equals(this.getID().toString());
        }
    ...
    void b(BlockPos blockPos) {
        NetworkRegistry.networkWrapper.sendToAllTracking((IMessage)new en_class260(this.girlID(), EnumParticleTypes.PORTAL.getParticleName(), 30), new net.minecraftforge.fml.common.network.NetworkRegistry.TargetPoint(this.dimension, this.posX, this.posY, this.posZ, 30.0));
    ...
    void b(UUID uUID, bs_class97 bs_class972) {
        ...
        if (this.ai == 0) {
            ...
            if (!(iBlockState.getBlock() instanceof BlockFalling)) {
                ...
                EntityPlayer object = this.net_minecraft_entity_player_EntityPlayer_z();
                if (object != null) {
                    NetworkRegistry.networkWrapper.sendTo((IMessage)new h6_class397(this.aI, false), (EntityPlayerMP)object);
                }
            }
    ...
    void a(UUID uUID, bs_class97 bs_class972) {
        ...
        if (this.aI == null || !bs_class972.g().contains(this.aI)) {
            ...
            if (this.aI == null) {
                ...
                NetworkRegistry.networkWrapper.sendTo((IMessage)new h6_class397(hashSet, false), (EntityPlayerMP)entityPlayer);
                return;
            }
        ...
        if (var3.isEmpty()) {
            ...
            if (var17.isEmpty()) {
                ...
                if (!var12.isEmpty()) {
                    ...
                    if (var23 != null) {
                        NetworkRegistry.networkWrapper.sendTo(new h6_class397(var12, true), (EntityPlayerMP)var23);
                    }
                }
                ...
                if (!var25.isEmpty()) {
                    ...
                    if (var28 != null) {
                        ...
                        if (var30 != null) {
                            NetworkRegistry.networkWrapper.sendTo(new h6_class397(var25, false), (EntityPlayerMP)var30);
                        }
                    }
                }
    ...
    void void_e() {
        ...
        if (this.boolean_J() && entityPlayer != null && entityPlayer.getDistance(this) < 2.0f && ((String)this.entityDataManager.get(v)).equals(entityPlayer.getPersistentID().toString())) {
            this.getNavigator().clearPath();
            return;
        }
    ...
    void a(UUID uUID, BlockPos blockPos, bs_class97 bs_class972) {
        ...
        if (this.W == 0) {
            NetworkRegistry.networkWrapper.sendToAllAround((IMessage)new a1_class7(this.girlID()), this.net_minecraftforge_fml_common_network_NetworkRegistry$TargetPoint_P());
        }
        ...
        if (!hashSet3.isEmpty() && entityPlayer != null) {
            NetworkRegistry.networkWrapper.sendTo((IMessage)new h6_class397(hashSet3, false), (EntityPlayerMP)entityPlayer);
        }
        int n2 = 1;
        while (true) {
            BlockPos blockPos2;
    ...
    public void readEntityFromNBT(NBTTagCompound nBTTagCompound) {
        ...
        this.entityDataManager.set(v, nBTTagCompound.getString("master"));
        ...
        AnimationController.ISoundListener iSoundListener = soundKeyframeEvent -> {
            switch (soundKeyframeEvent.sound) {
                ...
                case "blowjobStartMSG1": {
                    ...
                    NetworkRegistry.networkWrapper.sendToServer((IMessage)new a8_class16(this.getID().toString(), this.net_minecraft_util_math_Vec3d_o().add(vec3d), this.java_lang_Float_I().floatValue() + 180.0f, 0.0f));
                    break;
                }
                case "blowjobStartMSG2": {
                    ...
                    NetworkRegistry.networkWrapper.sendToServer((IMessage)new a8_class16(this.getID().toString(), this.net_minecraft_util_math_Vec3d_o().add(vec3d), this.java_lang_Float_I().floatValue() + 180.0f - 40.0f, 0.0f));
                    break;
                }
                case "lipsound": {
                ...
                case "analStartCam": {
                    ...
                    NetworkRegistry.networkWrapper.sendToServer((IMessage)new a8_class16(this.getID().toString(), this.net_minecraft_util_math_Vec3d_o().add(vec3d), this.java_lang_Float_I().floatValue(), 0.0f));
                    break;
                }
                case "pounding": {
                ...
                case "matingCam": {
                    ...
                    NetworkRegistry.networkWrapper.sendToServer((IMessage)new a8_class16(entityPlayerSP.getPersistentID().toString(), vec3d, this.java_lang_Float_I().floatValue() + 180.0f, 10.0f));
                    break;
                }
                ...
                case "mating_cum_cam": {
                    ...
                    vec3d = ck_class135.a(vec3d, this.java_lang_Float_I().floatValue() + 180.0f);
                    vec3d = vec3d.add(this.net_minecraft_util_math_Vec3d_o());
                    NetworkRegistry.networkWrapper.sendToServer((IMessage)new a8_class16(entityPlayerSP.getPersistentID().toString(), vec3d, this.java_lang_Float_I().floatValue() + 180.0f, 70.0f));
                    break;
                }
                case "cumMsg": {
