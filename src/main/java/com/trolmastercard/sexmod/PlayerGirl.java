...
extends Fighter {
    ...
    public void a(int n, Action action) {
        NetworkRegistry.networkWrapper.sendToAllTracking((IMessage)new gd_class361(this.java_util_UUID_m(), n, action), this.net_minecraftforge_fml_common_network_NetworkRegistry$TargetPoint_P());
    }
    ...
    protected void void_b(UUID uUID) {
        ...
        NetworkRegistry.networkWrapper.sendTo((IMessage)new gz_class393(false), entityPlayerMP2);
        this.void_e(uUID);
    ...
    public void a(String string, UUID uUID) {
        ...
        NetworkRegistry.networkWrapper.sendToServer((IMessage)new g4_class347(string, uUID, (UUID)this.entityDataManager.get(ai).get(), this.ab));
        this.ab = true;
    }
