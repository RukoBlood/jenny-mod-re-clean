...
implements bh_class82,
    ...
    public void SetHome() {
        ...
        this.PlaySound(SoundEventHandler.GIRLS_BIA_BREATH, new int[0]);
    }
    ...
    Vector4d javax_vecmath_Vector4d_a() {
        ...
        if (blockPos == null || n == 50) {
            this.PlaySound(SoundEventHandler.GIRLS_BIA_BREATH[2]);
        ...
        AnimationController.ISoundListener iSoundListener = soundKeyframeEvent -> {
            switch (soundKeyframeEvent.sound) {
                ...
                case "talk_hornyMSG1": {
                    ...
                    this.PlaySound(SoundEventHandler.GIRLS_BIA_HEY, new int[0]);
                    break;
                }
                case "talk_hornyMSG2": {
                ...
                case "doggyMoan": {
                    this.PlaySound(this.getRNG().nextBoolean() ? SoundEventHandler.GIRLS_BIA_AHH : SoundEventHandler.GIRLS_BIA_MMM, new int[0]);
                    if (!this.boolean_n()) break;
                    ds_class200.a(0.04);
                    break;
                }
